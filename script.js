...
// --- YENİ EKLENEN: MAÇ MERKEZİ KONTROLÜ ---
function toggleMatchCenter() {
    const playersContainer = document.getElementById("players");
    const panel = document.getElementById("match-center-panel");
    const channelName = document.getElementById("current-channel");

    if (panel.style.display === "none" || panel.style.display === "") {
        panel.style.display = "block";
        playersContainer.style.display = "none";
        channelName.innerText = "MAÇ VE SKOR MERKEZİ";
        if(window.innerWidth <= 768) toggleSidebar();
    } else {
        panel.style.display = "none";
        playersContainer.style.display = "grid";
        channelName.innerText = "YAYIN MERKEZİ";
    }
}
...
function playStream(url, name = "Bilinmeyen Kanal") {
    // YENİ: Kanal seçildiğinde maç merkezi açıksa kapat
    const matchPanel = document.getElementById("match-center-panel");
    const playersContainer = document.getElementById("players");
